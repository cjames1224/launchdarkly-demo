...
const { getDatabase, ref, onValue, set, child, get  } = require("firebase/database");
...
class FirebaseClient {
  ...
  static instance() {
    if(!FirebaseClient._instance){
      ...
      FirebaseClient._instance.firebaseApp = initializeApp(FirebaseClient._instance.config);
      FirebaseClient._instance.database = getDatabase(FirebaseClient._instance.firebaseApp);
